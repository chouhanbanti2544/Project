...
class Restaurant:
    ...
    def user_register(self, name, mobno, email, address, password):
        
        self.user_details={'NAME':name,'mobno':mobno,'EMAIL':email,'ADDRESS':address,'PASSWORD':password}
                                ...
                                if z=='1':                                        
                                    ...
                                    while True:
                                        try:
                                            ...
                                            print('\nPlease Enter Numeric No.- Discount\n')
                                            continue
                                    while True:
                                        try:
                ...
                while True:
                    ...
                    if x=='1':
                        while True:
                            ...
                            while True:
                                    try:
                                        phone = int(input("enter mob no - "))       
                                    except ValueError:
                                        print("enter numeric digit")
                                        continue        
                                    a=str(phone)    
                                    mob_ver = re.match("^[6-9][0-9]{9}$",a)
                                    if mob_ver:
                                        break
                                    else:
                                        print("phone no not vaild")
                                    continue
                                                                                                       
                            while True:
                                    email=input("enter email - ")
                                    a = re.match(r"^[a-z]+[\_|.]|[\w]+(@gmail.com)$",email)
                                    if a:
                                        break
                                    else:
                                        print("wrong email")
